...
| Audit trail | Varies | CLI identity tied to your OAuth provider (GitHub, Bitbucket Cloud, or GitLab) |
...
| Adoption metrics | Not built in | Dashboard and CLI (downloads, ready, applied / failure) |
| Team access | Share backend credentials | RBAC with management in the dashboard |
| Audit trail | No built in audit logging | CLI identity is tied to your OAuth provider (GitHub, Bitbucket Cloud, or GitLab) |
