...
:::tip
Before you rely on this stack in production, run `scripts/selfhost/backup.sh` and store a copy off the host. Restore and upgrade use the same scripts. See [Operations](/docs/reference/operations).
:::
