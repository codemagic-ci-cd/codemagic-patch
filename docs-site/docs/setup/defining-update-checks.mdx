...
You can toggle mandatory on an existing release with `cmpatch release patch` or `promote` with no new app binary required. See [Releasing updates](/docs/using-patch/releasing-updates).
...
Server-side targeting is covered in [Releasing updates](/docs/using-patch/releasing-updates).
