...
:::info
Most teams use the default [self-host](/docs/setup/self-host) Compose stack and never touch adapter settings. This page is for higher-scale or custom deployments, external object storage, a CDN in front of downloads, or splitting the API and worker.
:::
...
- [Self-host](/docs/setup/self-host): default install
