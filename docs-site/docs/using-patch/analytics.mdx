...
Under **Metrics**, drill from apps to deployments for rollups. See [Web dashboard](/docs/using-patch/dashboard) for a full walkthrough. Open it at your API URL after [install](/docs/install) (e.g. `https://updates.example.com/`).
