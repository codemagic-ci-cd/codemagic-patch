...
See [Web dashboard](/docs/using-patch/dashboard) for a full walkthrough. Open it at your API URL after [self-hosting](/docs/setup/self-host) (e.g. `https://updates.example.com/`).
