...
The Patch web dashboard is served from your API domain (e.g. `https://updates.example.com/`). Sign in with GitHub OAuth, the same identity model as `cmpatch login`.
