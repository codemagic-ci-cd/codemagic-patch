...
The dashboard uses GitHub OAuth. Installs with domains require a GitHub OAuth App; the first admin email must match a verified primary GitHub address when `REGISTRATION_MODE=invite_only`.
