...
On the client, `mandatoryInstallMode` controls *when* a mandatory update applies (default: `IMMEDIATE`). See [Defining update checks](/docs/setup/defining-update-checks).
