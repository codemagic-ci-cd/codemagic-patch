...
export async function startServer(
  ...
  const app = buildApp({
    ...
    deploymentFailureCodesHandler: runtime.deploymentFailureCodesHandler,
    deploymentFailureDistributionHandler: runtime.deploymentFailureDistributionHandler,
    deploymentFailureEventsHandler: runtime.deploymentFailureEventsHandler,
    ...
    http2Cleartext: config.http2Cleartext,
    ...
    oauthCliAuthorizationIssueHandler: runtime.oauthCliAuthorizationIssueHandler,
    oauthCliExchangeHandler: runtime.oauthCliExchangeHandler,
    ...
    releaseFailureCodesHandler: runtime.releaseFailureCodesHandler,
    releaseFailureDistributionHandler: runtime.releaseFailureDistributionHandler,
    releaseFailureEventsHandler: runtime.releaseFailureEventsHandler,
    ...
    serverStatusHandler: runtime.serverStatusHandler,
