...
// radius is off-grid (no @theme token) so it stays arbitrary. The identicon
// is a solid brand-blue tile (the legacy per-app gradients were dropped in
// the brand pass); callers only supply the initials.
...
export const APP_ICO =
  "grid size-[34px] flex-none place-items-center rounded-[10px] bg-blue text-[13px] font-bold text-white";
